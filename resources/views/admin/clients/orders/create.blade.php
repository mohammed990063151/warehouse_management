                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.clients.orders.store', $client->id ) }}" method="post">
                                ...
                                <div class="discuont-total">
                                    <h4>@lang('site.total') : <span class="total-price" id="total" >0</span></h4>
                                    <div class="form-group" style="
                                    display: flex;     align-items: center;
                                ">
                                        <label >@lang('site.sale_discuont'):</label> <input type="number"  class="form-control input-sm discuont" min="0" name="discuont"  id="discuont">
                                    </div>
                                <h4>@lang('site.total_discuont') : <span class="total-pricediscuont" id="total-discuont">0</span></h4>
                            </div>
