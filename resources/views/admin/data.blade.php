...
<script src="{{ asset('dashboard_files/plugins/jszip/jszip.min.js') }}"></script>
<script src="{{ asset('dashboard_files/plugins/pdfmake/pdfmake.min.js') }}"></script>
<script src="{{ asset('dashboard_files/plugins/pdfmake/vfs_fonts.js') }}"></script>
